...
for year in ['2018','2019']:
    ...
    for kernel_values_change in soil_kernel_values:
        ...
        hyperparameters_setting(['setted_epochs_num'],[20])
        
        if year=='2017':
            hyperparameters_setting(['training_years','testing_years'],[['2018','2019'],['2017']])
            BO_path=path+'2017Skernels4-8_Wkernels8-12S1W1TF11S2Y1GRU111.pkl'
        if year=='2018':
            hyperparameters_setting(['training_years','testing_years'],[['2017','2019'],['2018']])
            BO_path=path+'2018Skernels4-8_Wkernels8-12S1W1TF11S2Y1GRU111.pkl'
        if year=='2019':
            hyperparameters_setting(['training_years','testing_years'],[['2017','2018'],['2019']])
            BO_path=path+'2019Skernels4-8_Wkernels8-12S1W1TF11S2Y1GRU111.pkl'
        if year=='2019W':
            hyperparameters_setting(['training_years','testing_years'],[['2017','2018','2019'],['2019W']])
            BO_path=path+'2019WSkernels4-8_Wkernels8-12S1W1TF11S2Y1GRU111.pkl'
    ...
    for kernel_values_change in weather_kernel_values:
        ...
        if year=='2018':
            hyperparameters_setting(['training_years','testing_years'],[['2017','2019'],['2018']])
            BO_path=path+'2018_Skernels4-8_Wkernels8-12S1W1TF11S2Y1GRU111.pkl'
        if year=='2019':
            hyperparameters_setting(['training_years','testing_years'],[['2017','2018'],['2019']])
            BO_path=path+'2019_Skernels4-8_Wkernels8-12S1W1TF11S2Y1GRU111.pkl'
        if year=='2019w':
            hyperparameters_setting(['training_years','testing_years'],[['2017','2018','2019'],['2019W']])
            BO_path=path+'2019W_Skernels4-8_Wkernels8-12S1W1TF11S2Y1GRU111.pkl'
...
path='D:/quantification_growth_yield_prediction/1129_result/'
path='./'
...
hyperparameters_setting(['training_years','testing_years'],[['2017','2018'],['2019W']])
